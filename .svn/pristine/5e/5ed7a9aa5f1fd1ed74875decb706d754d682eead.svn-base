  ...
  <div class="tools-panel">
    <div class="tools-container">
      ...
      <i>模拟测试</i>
          ...
          <div class="tools-item " @click.stop="$router.push({name:'Examination',query:{type:1}})">
        <div class="tools-7"><svg-icon icon-class='test'/></div>
         <i>实操考试</i>
      </div>
            <div class="tools-item"  @click.stop="$router.push({name:'Sort_Item', query:{type:5}})">
